...
<tr>
 ...
 <td>{if $settings.usercanchangeegoldacc == 0 && $ps.account != ''}{$ps.account|escape:html}{else}<input type=text class=inpts size=30 name="pay_account[{$ps.id}]" value="{$ps.account|escape:html}">{/if}</td>
</tr>
{/foreach}
...
<tr>
 ...
 <td>{if $settings.usercanchangeegoldacc == 0 && $ps.value != ''}{$ps.value|escape:html}{else}<input type=text class=inpts size=30 name="pay_account[{$p.id}][{$ps.name|escape:html}]" value="{$ps.value|escape:html}">{/if}</td>
</tr>
{/foreach}
{/foreach}
<tr>
